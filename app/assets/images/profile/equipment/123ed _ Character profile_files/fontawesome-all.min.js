...
!function() {
    ...
    var t = v || {};
    t[z] || (t[z] = {}), t[z].styles || (t[z].styles = {}), t[z].hooks || (t[z].hooks = {}), 
    t[z].shims || (t[z].shims = []);
    var s = t[z], n = Object.assign || function(c) {
    ...
    !function(c) {
        ...
        !function c(l, h) {
            ...
            "function" == typeof s.hooks.addPack ? s.hooks.addPack(l, v) : s.styles[l] = n({}, s.styles[l] || {}, v), 
            "fas" === l && c("fa", h);
        }("fab", r);
    });
}(), function() {
    ...
    var e = (l.navigator || {}).userAgent, a = void 0 === e ? "" : e, m = l, t = h, s = v, n = z, r = !!m.document, f = !!t.documentElement && !!t.head && "function" == typeof t.addEventListener && "function" == typeof t.createElement, M = ~a.indexOf("MSIE") || ~a.indexOf("Trident/"), i = "___FONT_AWESOME___", H = 16, o = "svg-inline--fa", V = "data-fa-i2svg", C = "data-fa-pseudo-element", L = "fontawesome-i2svg", u = function() {
        ...
        return Array.from(c);
    }, x = m.FontAwesomeConfig || {}, A = Object.keys(x), q = k({
        familyPrefix: "fa",
        replacementClass: o,
        autoReplaceSvg: !0,
        autoAddCss: !0,
    ...
    N[i].shims || (N[i].shims = []);
    var E = N[i], P = [], T = !1;
    f && ((T = (t.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(t.readyState)) || t.addEventListener("DOMContentLoaded", function c() {
        t.removeEventListener("DOMContentLoaded", c), T = 1, P.map(function(c) {
            return c();
        });
    }));
    var _ = function(c) {
        f && (T ? setTimeout(c, 0) : P.push(c));
    }, I = H, B = {
        size: 16,
        x: 0,
        y: 0,
    ...
    function D(c) {
        if (c && f) {
            ...
            for (var h = t.head.childNodes, v = null, z = h.length - 1; z > -1; z--) {
                var e = h[z], a = (e.tagName || "").toUpperCase();
    ...
    var Q = {
        ...
        var l = c.children, h = c.attributes, v = c.main, z = c.mask, e = c.transform, a = v.width, m = v.icon, t = z.width, s = z.icon, n = J({
            transform: e,
            containerWidth: t,
            iconWidth: a
        }), r = {
            ...
            children: [ {
                tag: "path",
                attributes: k({}, m.attributes, n.path, {
                    fill: "black"
                })
            } ]
        }, M = {
        ...
        var l = c.children, h = c.main, v = c.mask, z = c.attributes, e = c.styles, a = c.transform;
        if (G(a) && h.found && !v.found) {
            var m = h.width / h.height / 2, t = .5;
            z.style = K(k({}, e, {
        ...
        var l = c.prefix, h = c.iconName, v = c.children, z = c.attributes, e = c.symbol, a = !0 === e ? l + "-" + O.familyPrefix + "-" + h : e;
        return [ {
            tag: "svg",
            attributes: {
                style: "display: none;"
    ...
    function hc(c) {
        var l = c.icons, h = l.main, v = l.mask, z = c.prefix, e = c.iconName, a = c.transform, m = c.symbol, t = c.title, s = c.extra, n = c.watchable, r = void 0 !== n && n, f = v.found ? v : h, M = f.width, i = f.height, H = "fa-w-" + Math.ceil(M / i * 16), o = [ O.replacementClass, e ? O.familyPrefix + "-" + e : "", H ].concat(s.classes).join(" "), C = {
            children: [],
        ...
        r && (C.attributes[V] = ""), t && C.children.push({
            tag: "title",
            attributes: {
                id: C.attributes["aria-labelledby"] || "title-" + F()
            },
            children: [ t ]
        });
        var L = k({}, C, {
    ...
    function vc(c) {
        var l = c.content, h = c.width, v = c.height, z = c.transform, e = c.title, a = c.extra, m = c.watchable, t = void 0 !== m && m, s = k({}, a.attributes, e ? {
            title: e
        } : {}, {
            class: a.classes.join(" ")
        });
        t && (s[V] = "");
        var n, r, f, i, o, C, L, u, d, p = k({}, a.styles);
        G(z) && (p.transform = (r = (n = {
            transform: z,
            startCentered: !0,
            width: h,
            height: v
        }).transform, f = n.width, i = void 0 === f ? H : f, o = n.height, C = void 0 === o ? H : o, 
        L = n.startCentered, d = "", d += (u = void 0 !== L && L) && M ? "translate(" + (r.x / I - i / 2) + "em, " + (r.y / I - C / 2) + "em) " : u ? "translate(calc(-50% + " + r.x / I + "em), calc(-50% + " + r.y / I + "em)) " : "translate(" + r.x / I + "em, " + r.y / I + "em) ", 
        d += "scale(" + r.size / I * (r.flipX ? -1 : 1) + ", " + r.size / I * (r.flipY ? -1 : 1) + ") ", 
        d += "rotate(" + r.rotate + "deg) "), p["-webkit-transform"] = p.transform);
        var g = K(p);
        g.length > 0 && (s.style = g);
        var b = [];
        return b.push({
            tag: "span",
            attributes: s,
    ...
    var zc = function() {}, ec = O.measurePerformance && n && n.mark && n.measure ? n : {
        ...
        var z, e, a, m, t, s = Object.keys(c), n = s.length, r = void 0 !== v ? (m = l, 
        t = v, function(c, l, h, v) {
            return m.call(t, c, l, h, v);
        }) : l;
        for (void 0 === h ? (z = 1, a = c[s[0]]) : (z = 0, a = h); z < n; z++) a = r(a, c[e = s[z]], e, c);
        return a;
    }, nc = E.styles, rc = E.shims, fc = {}, Mc = {}, ic = {}, Hc = function() {
        var c = function(c) {
            return sc(nc, function(l, h, v) {
                return l[v] = sc(h, c, {}), l;
            }, {});
        };
        fc = c(function(c, l, h) {
    ...
    function uc(c) {
        var l, h = c.tag, v = c.attributes, z = void 0 === v ? {} : v, e = c.children, a = void 0 === e ? [] : e;
    ...
    function bc(c, l) {
        ...
        0 === c.length ? h() : (m.requestAnimationFrame || function(c) {
            ...
            var l = !0 === O.autoReplaceSvg ? gc.replace : gc[O.autoReplaceSvg] || gc.replace, v = tc.begin("mutate");
            c.map(l), v(), h();
        });
    }
    var yc = !1;
    ...
    var Sc = function(c) {
        var l, h, v, z, e = c.getAttribute("data-prefix"), a = c.getAttribute("data-icon"), m = void 0 !== c.innerText ? c.innerText.trim() : "", t = Cc(W(c));
        return e && a && (t.prefix = e, t.iconName = a), t.prefix && m.length > 1 ? t.iconName = (v = t.prefix, 
        z = c.innerText, Mc[v][z]) : t.prefix && 1 === m.length && (t.iconName = (l = t.prefix, 
        h = function(c) {
            for (var l = "", h = 0; h < c.length; h++) l += ("000" + c.charCodeAt(h).toString(16)).slice(-4);
            return l;
        }(c.innerText), fc[l][h])), t;
    }, xc = function(c) {
        var l = {
            size: 16,
            x: 0,
        ...
        return O.autoA11y && (h ? l["aria-labelledby"] = O.replacementClass + "-title-" + F() : l["aria-hidden"] = "true"), 
        l;
    }, jc = function(c) {
    ...
    }, Bc = E.styles, Dc = "fa-layers-text", Xc = /Font Awesome 5 (Solid|Regular|Light|Brands)/, Fc = {
        Solid: "fas",
        Regular: "far",
        Light: "fal",
        Brands: "fab"
    ...
    function Wc(c) {
        var l, h, v, z, e, a, m, t, s, n, r, f, i, H, o, V, C, L, u, d = (h = Sc(l = c), 
        v = h.iconName, z = h.prefix, e = h.rest, a = kc(l), m = Ac(l), t = qc(l), s = Oc(l), 
        n = jc(l), {
            iconName: v,
        ...
        return ~d.extra.classes.indexOf(Dc) ? function(c, l) {
            var h = l.title, v = l.transform, z = l.extra, e = null, a = null;
            if (M) {
                var m = parseInt(getComputedStyle(c).fontSize, 10), t = c.getBoundingClientRect();
        ...
        }(c, d) : (r = c, i = (f = d).iconName, H = f.title, o = f.prefix, V = f.transform, 
        C = f.symbol, L = f.mask, u = f.extra, [ r, hc({
            icons: {
                main: Rc(i, o),
            ...
            yc = !0, function() {
                R(c.querySelectorAll("*")).forEach(function(c) {
                    [ ":before", ":after" ].forEach(function(l) {
                        var h = m.getComputedStyle(c, l), v = h.getPropertyValue("font-family").match(Xc), z = R(c.children).filter(function(c) {
                            return c.getAttribute(C) === l;
                        })[0];
                        if (z && (z.nextSibling && z.nextSibling.textContent.indexOf(C) > -1 && Yc(z.nextSibling), 
                        Yc(z), z = null), v && !z) {
                            var e = h.getPropertyValue("content"), a = t.createElement("i");
                            a.setAttribute("class", "" + Fc[v[1]]), a.setAttribute(C, l), a.innerText = 3 === e.length ? e.substr(1, 1) : e, 
                            ":before" === l ? c.insertBefore(a, c.firstChild) : c.appendChild(a);
                        }
                    });
                });
            }(), yc = !1, l();
    ...
    function Kc(c) {
        ...
        if (f) {
            var h = t.documentElement.classList, v = function(c) {
                return h.add(L + "-" + c);
            }, z = function(c) {
                return h.remove(L + "-" + c);
            }, e = Object.keys(Bc), a = [ "." + Dc + ":not([" + V + "])" ].concat(e.map(function(c) {
                return "." + c + ":not([" + V + "])";
            })).join(", ");
            if (0 !== a.length) {
                var m = R(c.querySelectorAll(a));
                if (m.length > 0) {
                    v("pending"), z("complete");
                    var s = tc.begin("onTree"), n = m.reduce(function(c, l) {
                        try {
                            var h = Wc(l);
                            h && c.push(h);
                        } catch (c) {
        ...
        return w(c, [ {
            ...
            value: function() {
                ...
                Object.keys(z).forEach(function(l) {
                    c.definitions[l] = k({}, c.definitions[l] || {}, z[l]), function c(l, h) {
                        var v = Object.keys(h).reduce(function(c, l) {
                            var v = h[l];
                            return v.icon ? c[v.iconName] = v.icon : c[l] = v, c;
                        }, {});
                        "function" == typeof E.hooks.addPack ? E.hooks.addPack(l, v) : E.styles[l] = k({}, E.styles[l] || {}, v), 
                        "fas" === l && c("fa", h);
                    }(l, z[l]);
                });
            }
            ...
            value: function(c, l) {
                ...
                return Object.keys(h).map(function(l) {
                    var v = h[l], z = v.prefix, e = v.iconName, a = v.icon;
                    c[z] || (c[z] = {}), c[z][e] = a;
                }), c;
            }
        } ]), c;
    ...
    var vl, zl = new Qc(), el = (vl = function(c) {
        var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, h = l.transform, v = void 0 === h ? B : h, z = l.symbol, e = void 0 !== z && z, a = l.mask, m = void 0 === a ? null : a, t = l.title, s = void 0 === t ? null : t, n = l.classes, r = void 0 === n ? [] : n, f = l.attributes, M = void 0 === f ? {} : f, i = l.styles, H = void 0 === i ? {} : i;
        if (c) {
            var o = c.prefix, V = c.iconName, C = c.icon;
            return ll(k({
                type: "icon"
            }, c), function() {
                return cl(), O.autoA11y && (s ? M["aria-labelledby"] = O.replacementClass + "-title-" + F() : M["aria-hidden"] = "true"), 
                hc({
                    icons: {
                        main: Zc(C),
                        mask: m ? Zc(m.icon) : {
        ...
        return v && (v = (v || {}).icon ? v : hl(v || {})), vl(h, k({}, l, {
            mask: v
        }));
    }), al = {
        noAuto: function() {
        ...
        dom: {
            i2svg: function() {
                ...
                if (f) {
                    cl();
                    var l = c.node, h = void 0 === l ? t : l, v = c.callback, z = void 0 === v ? function() {} : v;
        ...
        icon: el,
        text: function(c) {
            var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, h = l.transform, v = void 0 === h ? B : h, z = l.title, e = void 0 === z ? null : z, a = l.classes, m = void 0 === a ? [] : a, t = l.attributes, s = void 0 === t ? {} : t, n = l.styles, r = void 0 === n ? {} : n;
            return ll({
                type: "text",
                content: c
            }, function() {
        ...
        f && O.autoReplaceSvg && al.dom.i2svg({
            node: t
        });
    };
    Object.defineProperty(al, "config", {
        get: function() {
            return O;
        },
        set: function(c) {
        ...
        r && (m.FontAwesome || (m.FontAwesome = al), _(function() {
            Object.keys(E.styles).length > 0 && ml(), O.observeMutations && "function" == typeof MutationObserver && function(c) {
                if (s) {
                    ...
                    wc = new s(function(c) {
                        yc || R(c).forEach(function(c) {
                            ...
                            "attributes" === c.type && pc(c.target) && ~g.indexOf(c.attributeName)) if ("class" === c.attributeName) {
                                var z = Cc(W(c.target)), e = z.prefix, a = z.iconName;
                                e && c.target.setAttribute("data-prefix", e), a && c.target.setAttribute("data-icon", a);
                            } else h(c.target);
                        });
                    }), f && wc.observe(t.getElementsByTagName("body")[0], {
                        childList: !0,
                        attributes: !0,
                        characterData: !0,
                        subtree: !0
            ...
            addPack: function(c, l) {
                E.styles[c] = k({}, E.styles[c] || {}, l), Hc(), ml();
            },
            addShims: function(c) {
                var l;
                (l = E.shims).push.apply(l, S(c)), Hc(), ml();
            }
        });
    });
}();
